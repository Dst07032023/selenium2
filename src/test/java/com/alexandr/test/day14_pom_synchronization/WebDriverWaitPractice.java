...
import com.alexandr.pages.DynamicLoad1Page;
import com.alexandr.pages.DynamicLoad7Page;
...
//        wait.until(ExpectedConditions.visibilityOf(dynamicLoad7Page.spongeBobImage));
    ...
    public void dynamic_loading_1_test() {
        ...
        //wait.until(ExpectedConditions.visiblityOf(dynamicLoad1Page.errorMessage));
